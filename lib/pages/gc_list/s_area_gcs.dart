...
class SAreaGCs extends StatefulWidget {
  const SAreaGCs({Key? key,this.gcList,this.profile,this.AshalAccess,this.Area,this.user}) : super(key: key);
  ...
  @override
  State<SAreaGCs> createState() => _SAreaGCsState();
}

class _SAreaGCsState extends State<SAreaGCs> {
  @override
  String query='';
  ...
  void searchGc(String query) {
    final gcsSearch =widget.gcList!.where((w)  {
      final wellLower = w!.GC!.toLowerCase();
