...
class AllAreaGCs extends StatefulWidget {
  AllAreaGCs({Key? key,required this.gcList,this.profile,this.AshalAccess,this.Area,this.user}) : super(key: key);
  ...
  @override
  State<AllAreaGCs> createState() => _AllAreaGCsState();
}

class _AllAreaGCsState extends State<AllAreaGCs> {
  @override
  String query='';
