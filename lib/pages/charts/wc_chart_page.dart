...
class WCChartPage extends StatelessWidget {
   WCChartPage({Key? key,required this.WCSpots}) : super(key: key);
      ...
      Padding(
        ...
        child: LineChart(
          LineChartData(
            lineBarsData: [
              LineChartBarData(
                  spots: WCSpots, //points.map((point) => FlSpot(point.index.toDouble(), point.test)).toList(),
                  isCurved: false,
                  dotData: FlDotData(
                    show: true,
                  ),
