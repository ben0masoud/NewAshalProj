...
class OArea extends StatefulWidget {
   OArea({Key? key,required this.wellList,this.userPrivilege,this.user}) : super(key: key);
   final List<Well>? wellList;
   List<String>? userPrivilege;
   final String? user;

  @override
  State<OArea> createState() => _OAreaState();
}

class _OAreaState extends State<OArea> {
  @override
  String query='';
