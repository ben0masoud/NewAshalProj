class SlotCompConnection
{
  ...
  String? SLOT_SURFACE_FACILITY_S;
  ...
  SlotCompConnection.fromJson(Map<String, dynamic> json) {
    ...
    this.SLOT_SURFACE_FACILITY_S= json["SLOT_SURFACE_FACILITY_S"];
