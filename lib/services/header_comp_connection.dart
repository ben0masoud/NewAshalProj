class HeaderCompConnection
{
  ...
  String? HEADER_SURFACE_FACILITY_S;
  ...
  HeaderCompConnection(
      {this.HEADER
        ...
        ,this.HEADER_SURFACE_FACILITY_S
  ...
  HeaderCompConnection.fromJson(Map<String, dynamic> json) {
    ...
    this.HEADER_SURFACE_FACILITY_S= json["HEADER_SURFACE_FACILITY_S"];
